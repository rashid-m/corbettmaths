...
var ErrCodeMessage = map[int]struct {
	...
	ShardCommitteeLengthAndCommitteeIndexError:        {-1075, "Shard Committee Length And Committee GetIndex Error"},
	...
	BeaconCommitteeLengthAndCommitteeIndexError:       {-1092, "Shard Committee Length And Committee GetIndex Error"},
