...
// AllSubstituteCommittees provides a mock function with given fields:
func (_m *BeaconCommitteeState) AllSubstituteCommittees() []string {
	ret := _m.Called()
...
func (_m *BeaconCommitteeState) AssignInstructions(env *committeestate.BeaconCommitteeStateEnvironment) []*instruction.AssignInstruction {
	ret := _m.Called(env)
...
func (_m *BeaconCommitteeState) GenerateAllSwapShardInstructions(env *committeestate.BeaconCommitteeStateEnvironment) ([]*instruction.SwapShardInstruction, error) {
	ret := _m.Called(env)
...
// Mu provides a mock function with given fields:
func (_m *BeaconCommitteeState) Mu() *sync.RWMutex {
	ret := _m.Called()
...
func (_m *BeaconCommitteeState) NumberOfAssignedCandidates() int {
	ret := _m.Called()
...
func (_m *BeaconCommitteeState) Reset() {
	_m.Called()
}

// SetBeaconCommittees provides a mock function with given fields: _a0
func (_m *BeaconCommitteeState) SetBeaconCommittees(_a0 []incognitokey.CommitteePublicKey) {
	_m.Called(_a0)
}

// SetNumberOfAssignedCandidates provides a mock function with given fields: _a0
func (_m *BeaconCommitteeState) SetNumberOfAssignedCandidates(_a0 int) {
	_m.Called(_a0)
}

// SetSwapRule provides a mock function with given fields: _a0
func (_m *BeaconCommitteeState) SetSwapRule(_a0 committeestate.SwapRule) {
	_m.Called(_a0)
}

// SplitReward provides a mock function with given fields: _a0
func (_m *BeaconCommitteeState) SplitReward(_a0 *committeestate.BeaconCommitteeStateEnvironment) (map[common.Hash]uint64, map[common.Hash]uint64, map[common.Hash]uint64, map[common.Hash]uint64, error) {
	ret := _m.Called(_a0)
...
// SwapRule provides a mock function with given fields:
func (_m *BeaconCommitteeState) SwapRule() committeestate.SwapRule {
	ret := _m.Called()
...
// SyncPool provides a mock function with given fields:
func (_m *BeaconCommitteeState) SyncPool() map[byte][]incognitokey.CommitteePublicKey {
	ret := _m.Called()
...
func (_m *BeaconCommitteeState) SyncingValidators() map[byte][]incognitokey.CommitteePublicKey {
	ret := _m.Called()
...
// UnassignedCommonPool provides a mock function with given fields:
func (_m *BeaconCommitteeState) UnassignedCommonPool() []string {
	ret := _m.Called()
