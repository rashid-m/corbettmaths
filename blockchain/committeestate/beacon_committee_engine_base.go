...
func (engine *beaconCommitteeEngineBase) Clone() BeaconCommitteeEngine {
	finalState := cloneBeaconCommitteeStateFrom(engine.uncommittedState)
...
func (engine *beaconCommitteeEngineBase) GenerateAssignInstruction(rand int64, assignOffset int, activeShards int) ([]*instruction.AssignInstruction, []string, map[byte][]string) {
