...
func SetupParam() {
	...
	ChainTestParam = Params{
		...
		IsBackup:                  false,
		PreloadAddress:            "",
		BCHeightBreakPointNewZKP:  1060, //TODO: change this value when deployed testnet
	...
	ChainMainParam = Params{
		...
		IsBackup:                  false,
		PreloadAddress:            "",
		BCHeightBreakPointNewZKP:  934858, // beacon block height that applies new bullet proof
