...
var genesisParamsTestnetNew = GenesisParams{
	...
	InitialConstant: append(benchmark.InitTxsShard0, append(benchmark.InitTxsShard1, append(benchmark.InitTxsShard0_1, append(benchmark.InitTxsShard1_1, append(benchmark.InitTxsShard0_2, append(benchmark.InitTxsShard0_3, append(benchmark.InitTxsShard0_4, append(benchmark.InitTxsShard0_5, benchmark.InitTxsShard0_6...)...)...)...)...)...)...)...),
}
