...
func buildTestCaseAndExpectedResultCustodianDepositV3() ([]TestCaseCustodianDepositV3, *ExpectedResultCustodianDepositV3) {
	...
	testcases := []TestCaseCustodianDepositV3{
		// valid
		{
			...
			blockHash:         eCommon.HexToHash("0x708c2c91ec3316339c92f685b9eaf63ef77d8e784884dcfc122049e016964b9c"),
			txIndex:           0,
			proofStrs:         []string{""},
		},
		...
		// custodian is able to update new remote addresses when total collaterals is empty
		{
			...
			blockHash:         eCommon.HexToHash("0xa5c475e212ddc995e8ae6d0ff5697329c7d940fea12ffb4409d228d2ff81dda6"),
			txIndex:           0,
			proofStrs:         []string{"+FGgQyJ3tgRMZNNGQsj6WJUnyQbGUBhDuJtTTnvxKXwUs+yAgICAgICAoFR3R54AGET6UMLq8J+wZY26e4kmkJE7TrZYc4/OVGZvgICAgICAgIA= "},
		},
		// invalid: submit the used proof
		{
			...
			depositAmount:     1 * 1e8, // 0.1 ETH
			collateralTokenID: ETH_ID,
			blockHash:         eCommon.HexToHash("0x052bf2d84ed7ff491fee92f5c972064874e87b6bccf380d2d2fdce868fcc779a"),
			txIndex:           0,
			proofStrs:         []string{"+FGgkim5h9Db5fqlQSWhHU4r/Een/l9ayPW2RvRgg7/mFB+AgICAgICAoEgQ3HfIjb7iph+5ox+t2rxlS8cM0zlAsPnHJuMUQtt5gICAgICAgIA= "},
		},
		// new custodian deposit ERC20 (DAI)
		{
			...
			depositAmount:     10 * 1e9, // 10 DAI
			collateralTokenID: DAI_ID,
			blockHash:         eCommon.HexToHash("0xe20c9ce7f574c56bf4e6a5581c5dc67733f572d605fc2fca8a1ead8697d54c50"),
			txIndex:           0,
			proofStrs:         []string{"+FGgI4BYmPQn1Z8GX6I/S66oN5kC8K9nJK0f7vjIx462cPeAgICAgICAoMcZ/82EkEqECH4LANdv6vQRDTQLpqmo6rcvKsCNoroUgICAgICAgIA= "},
		},
		// invalid: collateral tokenID is not supported
		{
			...
			blockHash:         eCommon.HexToHash("0x8042b68712126e8b44448459e49ca749b1017e0c7664c218eac4df3fd4f7fd95"),
			txIndex:           0,
			proofStrs:         []string{"+FGgSnC5szaIJUmGb0yLUtpiDUuy4En6iLj6f8k+02wV1s+AgICAgICAoMcZ/82EkEqECH4LANdv6vQRDTQLpqmo6rcvKsCNoroUgICAgICAgIA= "},
		},
	}
