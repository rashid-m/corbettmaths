	...
	tests := []struct {
	...
	}{
		{
			...
			wantResInsts: [][]string{
				{
					"345", "1", "rejected",
					"",
				},
			},
			wantResUnifiedTokenInfos: map[common.Hash]map[uint]*Vault{},
			wantErr:                  false,
