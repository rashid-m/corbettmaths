...
func Test_stateProducer_unshield(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantResInsts: [][]string{
				{
					"346", "1", "rejected", "",
				},
			},
			wantResUnifiedTokenInfos: map[common.Hash]map[uint]*Vault{},
			wantErr:                  false,
