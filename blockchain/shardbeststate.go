...
type ShardBestState struct {
	...
	// TODO: produce merkle root for staking tx
	StakingTx              map[string]string                 `json:"StakingTx"` //TODO: delete staking transaction for beacon committee when it is swapped out
