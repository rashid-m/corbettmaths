...
func (self GenesisBlockGenerator) CreateGenesisBlockPoSParallel(nonce int, difficulty uint32, version int, initialCoin uint64, initialAddress string, preSelectValidators []string, initSalaryFund uint64) *Block {
	//init the loc
