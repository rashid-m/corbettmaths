...
func (self *Block) Hash() (*common.Hash) {
	...
	//}
	record := strconv.Itoa(self.Header.Version) + self.Header.MerkleRoot.String() + self.Header.Timestamp.String() + self.Header.PrevBlockHash + strconv.Itoa(self.Header.Nonce) + strconv.Itoa(len(self.Transactions))
