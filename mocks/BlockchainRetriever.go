...
// GetAllCoinID provides a mock function with given fields:
func (_m *BlockchainRetriever) GetAllCoinID() ([]common.Hash, error) {
	ret := _m.Called()
...
func (_m *BlockchainRetriever) GetDatabase() database.DatabaseInterface {
	ret := _m.Called()

	var r0 database.DatabaseInterface
	if rf, ok := ret.Get(0).(func() database.DatabaseInterface); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(database.DatabaseInterface)
		}
	}
