...
type config struct {
	...
	MaxOutPeers          int           `long:"maxoutpeers" description:"Max number of inbound and outbound peers"`
	MaxInPeers           int           `long:"maxpeers" description:"Max number of inbound and outbound peers"`
