...
testnet-1:
	INCOGNITO_NETWORK_KEY=$(TESTNET) INCOGNITO_CONFIG_MODE_KEY=$(FILE_MODE) INCOGNITO_NETWORK_VERSION_KEY=$(VERSION_1) ./$(BUILD_FILE_NAME)

testnet-2:
	INCOGNITO_NETWORK_KEY=$(TESTNET) INCOGNITO_CONFIG_MODE_KEY=$(FILE_MODE) INCOGNITO_NETWORK_VERSION_KEY=$(VERSION_2) ./$(BUILD_FILE_NAME)
