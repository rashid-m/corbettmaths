...
func CreateCustomTokenPrivacyBurningReceiverArrayV2(dataReceiver interface{}, bcr basemeta.ChainRetriever, beaconHeight uint64) ([]*privacy.PaymentInfo, int64, error) {
	if dataReceiver == nil {
		return nil, 0, fmt.Errorf("data receiver is in valid")
	}
	result := []*privacy.PaymentInfo{}
