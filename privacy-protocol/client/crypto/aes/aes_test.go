...
// Appendix A of FIPS 197: PubKey expansion examples
type KeyTest struct {
	key []byte
	enc []uint32
...
var keyTests = []KeyTest{
	{
		// A.1.  Expansion of a 128-bit Cipher PubKey
	...
	{
		// A.2.  Expansion of a 192-bit Cipher PubKey
		[]byte{
	...
	{
		// A.3.  Expansion of a 256-bit Cipher PubKey
		[]byte{
