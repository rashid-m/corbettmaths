...
GETH_NAME=kovan.infura.io/v3/1f15d22470684b4a8c92c130925fc679 GETH_PROTOCOL=https GETH_PORT="" ./incognito --testnet true --relayshards "all" --is_full_validation true --externaladdress "127.0.0.1:9432" --enablewallet --wallet "wallet" --walletpassphrase "12345678" --walletautoinit --norpcauth --datadir "../testnet12/fullnode" --discoverpeersaddress "testnet-bootnode.incognito.org:9330" --norpcauth --rpclisten "0.0.0.0:7334" --rpcwslisten "127.0.0.1:17338" > ../testnet12/log.txt 2> ../testnet12/error_log.txt &
fi
if [ "$1" == "fullnode-testnet2" ]; then
INCOGNITO_NETWORK_KEY=testnet-2 GETH_NAME=kovan.infura.io/v3/1f15d22470684b4a8c92c130925fc679 GETH_PROTOCOL=https GETH_PORT="" ./incognito --testnet 1 --testnetversion "2" --relayshards "all" --externaladdress "127.0.0.1:9431" --enablewallet --wallet "wallet" --walletpassphrase "12345678" --walletautoinit --norpcauth --datadir "./data/testnet-2/fullnode" --discoverpeersaddress "74.207.247.250:9330" --norpcauth --rpclisten "0.0.0.0:6334" --rpcwslisten "127.0.0.1:16338" > ./data/testnet-2/log.txt 2> ./data/testnet-2/error_log.txt &
fi
