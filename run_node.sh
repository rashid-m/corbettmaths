...
GO111MODULE=on GETH_NAME=mainnet.infura.io/v3/1f15d22470684b4a8c92c130925fc679 GETH_PROTOCOL=https GETH_PORT="" ./incognito --testnet false --nodemode "relay" --externaladdress "127.0.0.1:5433" --enablewallet --wallet "wallet" --walletpassphrase "12345678" --walletautoinit --norpcauth --datadir "./mainnet/fullnode" --discoverpeersaddress "51.91.72.45:9330" --norpcauth --rpclisten "0.0.0.0:5334" --rpcwslisten "127.0.0.1:15338" > ./mainnet/log.txt 2> ./mainnet/error_log.txt &
fi
######
