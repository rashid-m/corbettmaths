...
type IConsensusValidator interface {
	FilterValidProposeBlockInfo(bestViewHeight uint64, finalViewHeight uint64, currentTimeSlot int64, proposeBlockInfos map[string]*ProposeBlockInfo) ([]*ProposeBlockInfo, []*ProposeBlockInfo, []string)
...
func NewConsensusValidator(logger common.Logger, chain Chain) *ConsensusValidator {
	return &ConsensusValidator{logger: logger, chain: chain}
}
...
func (c ConsensusValidator) FilterValidProposeBlockInfo(bestViewHeight uint64, finalViewHeight uint64, currentTimeSlot int64, proposeBlockInfos map[string]*ProposeBlockInfo) ([]*ProposeBlockInfo, []*ProposeBlockInfo, []string) {
...
func (c ConsensusValidator) ValidateBlock(lastVotedBlock types.BlockInterface, isVoteNextHeight bool, proposeBlockInfo *ProposeBlockInfo) (bool, error) {
...
func (c ConsensusValidator) ValidateConsensusRules(lastVotedBlock types.BlockInterface, isVoteNextHeight bool, proposeBlockInfo *ProposeBlockInfo) bool {
