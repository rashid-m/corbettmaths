...
func (a *actorV2) handleProposeMsg(proposeMsg BFTPropose) error {
	...
	if a.chain.IsBeaconChain() {
		stateRes := fork.ForkBeaconWithInstruction("forkBSC", a.chain.GetMultiView(), "151", a.chain.GetFinalView().GetBlock().(*types.BeaconBlock), blockInfo.(*types.BeaconBlock), 4)
