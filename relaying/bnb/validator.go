...
var ValidatorAddressesTestnet = []string{
	"1935930EEB68D9B08589381E87BCDC8350F1AD13",
}

// public key on ed25519 curve (base64 encoded)
var ValidatorB64EncodePubKeysTestnet = []string{
	"O6ZcNqhg97e2rAL873tUm9c66RTdXh+423O+C1B8Kgc=",
}

// ValidatorPubKeyBytes are results from base-64 decoding ValidatorB64EncodePubKeys
var ValidatorPubKeyBytesTestnet = [][]byte{
	[]byte{0x3b, 0xa6, 0x5c, 0x36, 0xa8, 0x60, 0xf7, 0xb7, 0xb6, 0xac, 0x2, 0xfc, 0xef, 0x7b, 0x54, 0x9b, 0xd7, 0x3a, 0xe9, 0x14, 0xdd, 0x5e, 0x1f, 0xb8, 0xdb, 0x73, 0xbe, 0xb, 0x50, 0x7c, 0x2a, 0x7},
}
