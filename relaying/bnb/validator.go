...
var ValidatorAddressesTestnet = []string{
	"7975C8F15B7D810C91FB30151248977A3144DB71",
}

// public key on ed25519 curve (base64 encoded)
var ValidatorB64EncodePubKeysTestnet = []string{
	"7+dJPS7kUrgRdnCZJ368x+14am91/XwATCqSs9Xp2FE=",
}

// ValidatorPubKeyBytes are results from base-64 decoding ValidatorB64EncodePubKeys
var ValidatorPubKeyBytesTestnet = [][]byte{
	{0xef, 0xe7, 0x49, 0x3d, 0x2e, 0xe4, 0x52, 0xb8, 0x11, 0x76, 0x70, 0x99, 0x27, 0x7e, 0xbc, 0xc7, 0xed, 0x78, 0x6a, 0x6f, 0x75, 0xfd, 0x7c, 0x0, 0x4c, 0x2a, 0x92, 0xb3, 0xd5, 0xe9, 0xd8, 0x51},
}
