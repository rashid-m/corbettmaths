...
func (staker *Pdexv3StakerState) LastUpdatedBeaconHeight() uint64 {
...
func NewPdexv3StakerStateWithValue(nftID common.Hash, liquidity, lastUpdatedBeaconHeight uint64) *Pdexv3StakerState {
	return &Pdexv3StakerState{
		liquidity:               liquidity,
