...
func (staker *Pdexv3StakerState) AccessOTA() string {
...
func NewPdexv3StakerStateWithValue(nftID common.Hash, liquidity uint64, accessOTA string) *Pdexv3StakerState {
	return &Pdexv3StakerState{
		nftID:     nftID,
		liquidity: liquidity,
		accessOTA: accessOTA,
