...
func NewPdexv3StakerRewardState() *Pdexv3StakerRewardState { return &Pdexv3StakerRewardState{} }
...
func newPdexv3StakerRewardObjectWithValue(db *StateDB, key common.Hash, data interface{}) (*Pdexv3StakerRewardObject, error) {
...
func (object *Pdexv3StakerRewardObject) IsEmpty() bool {
	temp := NewPdexv3StakerRewardState()
