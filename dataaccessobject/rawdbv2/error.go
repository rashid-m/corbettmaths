...
var ErrCodeMessage = map[int]struct {
	...
	GetBeaconBlockByIndexError:    {-1002, "Get Beacon Block By GetIndex Error"},
	DeleteBeaconBlockError:        {-1003, "Delete Beacon Block Error"},
	StoreBeaconBlockIndexError:    {-1004, "Store Beacon Block GetIndex Error"},
	GetIndexOfBeaconBlockError:    {-1005, "Get GetIndex Of Beacon Block Error"},
	...
	GetShardBlockByIndexError:      {-2003, "Get Shard Block By GetIndex Error"},
	...
	StoreShardBlockIndexError:      {-2007, "Store Shard Block GetIndex Error"},
	...
	StoreTransactionIndexError:   {-3000, "Store Transaction GetIndex Error"},
