...
func (c *Consensus) ValidateBlockCommitteeSig(block types.BlockInterface, committee []incognitokey.CommitteePublicKey) error {
	return c.consensusEngine.ValidateBlockCommitteeSig(block, committee)
}
