...
func (txService TxService) BuildRawDefragmentAccountTransactionV2(params interface{}, meta basemeta.Metadata) (*transaction.Tx, *RPCError) {
	arrayParams := common.InterfaceSlice(params)
	if len(arrayParams) < 4 {
		return nil, NewRPCError(RPCInvalidParamsError, nil)
	}
...
func (txService TxService) BuildRawDefragmentPrivacyCustomTokenTransactionV2(params interface{}, metaData basemeta.Metadata) (*transaction.TxCustomTokenPrivacy, *RPCError) {
	txParam, errParam := bean.NewCreateRawPrivacyTokenTxParamV2(params)
	if errParam != nil {
		return nil, NewRPCError(RPCInvalidParamsError, errParam)
	}
