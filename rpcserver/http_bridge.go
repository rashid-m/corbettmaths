...
func (httpServer *HttpServer) handleCreateAndSendTxWithIssuingNearReq(params interface{},
	closeChan <-chan struct{}) (interface{}, *rpcservice.RPCError) {
	data, err := httpServer.handleCreateRawTxWithIssuingWasmReq(params, closeChan, metadata.IssuingNearRequestMeta)
	if err != nil {
		return nil, rpcservice.NewRPCError(rpcservice.UnexpectedError, err)
	}
	tx := data.(jsonresult.CreateTransactionResult)
...
func (httpServer *HttpServer) handleCreateAndSendBurningNearRequest(params interface{},
	closeChan <-chan struct{}) (interface{}, *rpcservice.RPCError) {
	data, err := httpServer.handleCreateRawTxWithBurningNearReq(params, closeChan)
	if err != nil {
		return nil, rpcservice.NewRPCError(rpcservice.UnexpectedError, err)
	}
