...
func (httpServer *HttpServer) handleCreateRawTxWithIssuingWasmReq(params interface{}, closeChan <-chan struct{}, metatype int) (interface{}, *rpcservice.RPCError) {
	arrayParams := common.InterfaceSlice(params)
	if arrayParams == nil || len(arrayParams) < 5 {
		return nil, rpcservice.NewRPCError(rpcservice.RPCInvalidParamsError, errors.New("param must be an array at least 5 elements"))
	}
	...
	meta, err := metadataBridge.NewIssuingWasmRequestFromMap(data, 5, metatype)
	if err != nil {
		rpcErr := rpcservice.NewRPCError(rpcservice.UnexpectedError, err)
		Logger.log.Error(rpcErr)
		return nil, rpcErr
...
// shield
func (httpServer *HttpServer) handleCreateAndSendTxWithIssuingTerraReq(params interface{},
	closeChan <-chan struct{}) (interface{}, *rpcservice.RPCError) {
	data, err := httpServer.handleCreateRawTxWithIssuingWasmReq(params, closeChan, metadata.IssuingTerraRequestMeta)
	if err != nil {
		return nil, rpcservice.NewRPCError(rpcservice.UnexpectedError, err)
	}
	tx := data.(jsonresult.CreateTransactionResult)
...
// unshield
func (httpServer *HttpServer) handleCreateRawTxWithBurningTerraReq(params interface{},
	closeChan <-chan struct{}) (interface{}, *rpcservice.RPCError) {
	return processBurningReq(
		metadata.BurningTerraRequestMeta,
		params,
		closeChan,
		httpServer,
		false,
...
func (httpServer *HttpServer) handleCreateAndSendBurningTerraRequest(params interface{},
	closeChan <-chan struct{}) (interface{}, *rpcservice.RPCError) {
	data, err := httpServer.handleCreateRawTxWithBurningTerraReq(params, closeChan)
	if err != nil {
		return nil, rpcservice.NewRPCError(rpcservice.UnexpectedError, err)
	}
...
func (httpServer *HttpServer) handleCreateRawTxWithBurningTerraForDepositToSCReq(params interface{},
	closeChan <-chan struct{}) (interface{}, *rpcservice.RPCError) {
	return processBurningReq(
		metadata.BurningTerraForDepositToSCRequestMeta,
		params,
		closeChan,
		httpServer,
		false,
...
func (httpServer *HttpServer) handleCreateAndSendBurningLUNForDepositToSCRequest(params interface{}, closeChan <-chan struct{}) (interface{}, *rpcservice.RPCError) {
	data, err := httpServer.handleCreateRawTxWithBurningTerraForDepositToSCReq(params, closeChan)
	if err != nil {
		return nil, rpcservice.NewRPCError(rpcservice.UnexpectedError, err)
	}
	tx := data.(jsonresult.CreateTransactionResult)
