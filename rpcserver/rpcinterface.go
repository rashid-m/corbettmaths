...
var HttpHandler = map[string]httpHandler{
	...
	createAndSendTxWithIssuingPDEXERC20Req: (*HttpServer).handleCreateAndSendTxWithIssuingPDEXERC20Req,
	createAndSendTxWithIssuingPDEXBEP20Req: (*HttpServer).handleCreateAndSendTxWithIssuingPDEXBEP20Req,
