...
var HttpHandler = map[string]httpHandler{
	...
	createEVMDepositTxWithDepositKey:        (*HttpServer).handleCreateEVMDepositTxWithDepositKey,
	createAndSendEVMDepositTxWithDepositKey: (*HttpServer).handleCreateAndSendEVMDepositTxWithDepositKey,
