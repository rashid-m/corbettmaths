...
var HttpHandler = map[string]httpHandler{
	...
	createAndSendBurningBSCRequest:                (*HttpServer).handleCreateAndSendBurningBSCToWithdrawRequest,
	createAndSendBurningPBSCForDepositToSCRequest: (*HttpServer).handleCreateAndSendBurningBSCToDepositWithdrawRequest,
	...
	getBSCBurnProof:               (*HttpServer).handleGetBSCBurnWithdrawProof,
	getBSCBurnProofForDepositToSC: (*HttpServer).handleGetBSCBurnWithdrawToDepositSCProof,
