...
func TestGenerateMasterPubKeysFromSeeds(t *testing.T) {
	...
	seeds := [][]byte{
		[]byte{0x2, 0x40, 0xce, 0xfd, 0x54, 0x38, 0xce, 0x3f, 0xa2, 0x9d, 0x98, 0x94, 0x50, 0xc6, 0x17, 0x42, 0xf5, 0x2b, 0x1, 0xcf, 0xee, 0x9, 0x90, 0xa1, 0x8b, 0x83, 0x2c, 0x92, 0x88, 0x4a, 0xf2, 0x16, 0xdc},
		[]byte{0x2, 0xaf, 0x6d, 0x7e, 0x12, 0x34, 0x6c, 0x89, 0x4e, 0x26, 0xfc, 0xd8, 0xd6, 0xe0, 0xd6, 0x2c, 0xbb, 0x2, 0x43, 0x46, 0xcc, 0xc4, 0x4e, 0x9b, 0xe0, 0x48, 0x7e, 0x7c, 0x80, 0x86, 0xa5, 0xd2, 0x9e},
		[]byte{0x3, 0x7a, 0x45, 0xb3, 0x64, 0x25, 0x75, 0x11, 0x24, 0x0, 0x4, 0xd3, 0x7d, 0x96, 0x66, 0x6a, 0xb4, 0xda, 0x7f, 0xee, 0xc8, 0x68, 0x54, 0xfa, 0xb7, 0x17, 0x1f, 0xd1, 0xe5, 0x16, 0x75, 0xf8, 0x49},
		[]byte{0x3, 0x18, 0xab, 0xb, 0xad, 0x76, 0x50, 0xd5, 0x34, 0x14, 0xba, 0x4d, 0xd5, 0xb6, 0xf9, 0xbc, 0x46, 0xf, 0x25, 0xe4, 0x81, 0x66, 0x2d, 0xb7, 0x8b, 0x8b, 0xae, 0x93, 0x20, 0x82, 0xb3, 0xa8, 0xab},
	}
	...
	btcToken := PortalBTCTokenProcessor{
		...
		ChainParam:    &chaincfg.TestNet3Params,
		PortalTokenID: "ef5947f70ead81a76a53c7c8b7317dd5245510c665d3a13921dc9a581188728b",
	}
...
func TestGenerateOTMultisigAddress(t *testing.T) {
	...
	fmt.Printf("P2WSH Bech32 address: %v\n", address)
	fmt.Printf("P2WSH Bech32 hex encode: %v\n", hex.EncodeToString(script))
}
