...
func (p PortalTopUpWaitingPortingRequest) ValidateMetadataByItself() bool {
	return p.Type == basemeta.PortalTopUpWaitingPortingRequestMeta
}
...
func (p *PortalTopUpWaitingPortingRequest) BuildReqActions(
	...
	action := []string{strconv.Itoa(basemeta.PortalTopUpWaitingPortingRequestMeta), actionContentBase64Str}
	return [][]string{action}, nil
}

func (p *PortalTopUpWaitingPortingRequest) CalculateSize() uint64 {
	return basemeta.CalculateSize(p)
}
