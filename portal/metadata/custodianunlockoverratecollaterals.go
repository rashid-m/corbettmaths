...
func (portalUnlockCs PortalUnlockOverRateCollaterals) ValidateSanityData(chainRetriever basemeta.ChainRetriever, shardViewRetriever basemeta.ShardViewRetriever, beaconViewRetriever basemeta.BeaconViewRetriever, beaconHeight uint64, txr basemeta.Transaction) (bool, bool, error) {
	...
	if !chainRetriever.IsPortalToken(beaconHeight, portalUnlockCs.TokenID) {
		return false, false, basemeta.NewMetadataTxError(basemeta.PortalUnlockOverRateCollateralsError, errors.New("TokenID is not in portal tokens list"))
	}
...
func (portalUnlockCs PortalUnlockOverRateCollaterals) ValidateMetadataByItself() bool {
	return portalUnlockCs.Type == basemeta.PortalUnlockOverRateCollateralsMeta
}
...
func (portalUnlockCs *PortalUnlockOverRateCollaterals) BuildReqActions(tx basemeta.Transaction, chainRetriever basemeta.ChainRetriever, shardViewRetriever basemeta.ShardViewRetriever, beaconViewRetriever basemeta.BeaconViewRetriever, shardID byte, shardHeight uint64) ([][]string, error) {
	...
	action := []string{strconv.Itoa(basemeta.PortalUnlockOverRateCollateralsMeta), actionContentBase64Str}
	return [][]string{action}, nil
}

func (portalUnlockCs *PortalUnlockOverRateCollaterals) CalculateSize() uint64 {
	return basemeta.CalculateSize(portalUnlockCs)
}
