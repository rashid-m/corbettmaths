...
func (req PortalTopUpWaitingPortingRequestV3) ValidateSanityData(chainRetriever basemeta.ChainRetriever, shardViewRetriever basemeta.ShardViewRetriever, beaconViewRetriever basemeta.BeaconViewRetriever, beaconHeight uint64, txr basemeta.Transaction) (bool, bool, error) {
...
func (req PortalTopUpWaitingPortingRequestV3) ValidateMetadataByItself() bool {
	return req.Type == basemeta.PortalTopUpWaitingPortingRequestMetaV3
}
...
func (req *PortalTopUpWaitingPortingRequestV3) BuildReqActions(tx basemeta.Transaction, chainRetriever basemeta.ChainRetriever, shardViewRetriever basemeta.ShardViewRetriever, beaconViewRetriever basemeta.BeaconViewRetriever, shardID byte, shardHeight uint64) ([][]string, error) {
	...
	action := []string{strconv.Itoa(basemeta.PortalTopUpWaitingPortingRequestMetaV3), actionContentBase64Str}
