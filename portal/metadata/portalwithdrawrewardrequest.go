...
func (meta PortalRequestWithdrawReward) ValidateSanityData(chainRetriever basemeta.ChainRetriever, shardViewRetriever basemeta.ShardViewRetriever, beaconViewRetriever basemeta.BeaconViewRetriever, beaconHeight uint64, txr basemeta.Transaction) (bool, bool, error) {
...
func (meta PortalRequestWithdrawReward) ValidateMetadataByItself() bool {
	return meta.Type == basemeta.PortalRequestWithdrawRewardMeta
}
...
func (meta *PortalRequestWithdrawReward) BuildReqActions(tx basemeta.Transaction, chainRetriever basemeta.ChainRetriever, shardViewRetriever basemeta.ShardViewRetriever, beaconViewRetriever basemeta.BeaconViewRetriever, shardID byte, shardHeight uint64) ([][]string, error) {
	...
	action := []string{strconv.Itoa(basemeta.PortalRequestWithdrawRewardMeta), actionContentBase64Str}
