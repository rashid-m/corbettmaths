...
func (p *portalRedeemRequestProcessor) prepareDataBeforeProcessing(stateDB *statedb.StateDB, contentStr string) (map[string]interface{}, error) {
	...
	var actionData metadata2.PortalRedeemRequestActionV3
...
func buildRedeemRequestInst(
	...
	redeemRequestContent := metadata2.PortalRedeemRequestContent{
...
func buildReqMatchingRedeemInst(
	...
	reqMatchingRedeemContent := metadata2.PortalReqMatchingRedeemContent{
...
func (p *portalRequestMatchingRedeemProcessor) buildNewInsts(
	...
	var actionData metadata2.PortalReqMatchingRedeemAction
	err = json.Unmarshal(actionContentBytes, &actionData)
	if err != nil {
...
func buildReqUnlockCollateralInst(
	...
	reqUnlockCollateralContent := metadata2.PortalRequestUnlockCollateralContent{
		UniqueRedeemID:      uniqueRedeemID,
		TokenID:             tokenID,
...
func (p *portalRequestUnlockCollateralProcessor) buildNewInsts(
	...
	var actionData metadata2.PortalRequestUnlockCollateralAction
	err = json.Unmarshal(actionContentBytes, &actionData)
	if err != nil {
