...
then
	...
	sudo wget https://github.com/ninjadotorg/cash-prototype/releases/download/zkpp-v0.0.3/proving.key
fi
...
then
	...
	sudo wget https://github.com/ninjadotorg/cash-prototype/releases/download/zkpp-v0.0.3/verifying.key
fi
