...
func (meta PortalRequestUnlockCollateral) ValidateSanityData(bcr BlockchainRetriever, txr Transaction, beaconHeight uint64) (bool, bool, error) {
...
func (meta *PortalRequestUnlockCollateral) BuildReqActions(tx Transaction, bcr BlockchainRetriever, shardID byte) ([][]string, error) {
