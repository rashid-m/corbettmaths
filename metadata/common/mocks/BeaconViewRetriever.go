...
// IsValidAccessOTAWithPdexState provides a mock function with given fields: _a0
func (_m *BeaconViewRetriever) IsValidAccessOTAWithPdexState(_a0 common.Pdexv3ExtendedAccessID) (bool, error) {
	ret := _m.Called(_a0)

	var r0 bool
	if rf, ok := ret.Get(0).(func(common.Pdexv3ExtendedAccessID) bool); ok {
		r0 = rf(_a0)
	} else {
		r0 = ret.Get(0).(bool)
	}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(common.Pdexv3ExtendedAccessID) error); ok {
		r1 = rf(_a0)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *BeaconViewRetriever) IsValidPdexv3LP(_a0 string, _a1 string) (bool, error) {
...
// IsValidPdexv3MintNftRequireAmount provides a mock function with given fields: _a0
func (_m *BeaconViewRetriever) IsValidPdexv3MintNftRequireAmount(_a0 uint64) (bool, error) {
	ret := _m.Called(_a0)
...
// IsValidPdexv3NftID provides a mock function with given fields: _a0
func (_m *BeaconViewRetriever) IsValidPdexv3NftID(_a0 string) (bool, error) {
	ret := _m.Called(_a0)
...
// IsValidPdexv3PoolPairID provides a mock function with given fields: _a0
func (_m *BeaconViewRetriever) IsValidPdexv3PoolPairID(_a0 string) (bool, error) {
	ret := _m.Called(_a0)
...
func (_m *BeaconViewRetriever) IsValidPdexv3ShareAmount(_a0 string, _a1 string, _a2 uint64) (bool, error) {
...
// IsValidPdexv3Staker provides a mock function with given fields: _a0, _a1
func (_m *BeaconViewRetriever) IsValidPdexv3Staker(_a0 string, _a1 string) (bool, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *BeaconViewRetriever) IsValidPdexv3StakingPool(_a0 string) (bool, error) {
	ret := _m.Called(_a0)
...
func (_m *BeaconViewRetriever) IsValidPdexv3UnstakingAmount(_a0 string, _a1 string, _a2 uint64) (bool, error) {
	ret := _m.Called(_a0, _a1, _a2)
