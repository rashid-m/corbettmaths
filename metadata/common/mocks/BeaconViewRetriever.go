...
// GetAllBeaconValidatorCandidateFlattenList provides a mock function with given fields:
func (_m *BeaconViewRetriever) GetAllBeaconValidatorCandidateFlattenList() []string {
	ret := _m.Called()
