...
func (_m *Transaction) GetTxBurnData() (bool, coin.Coin, *common.Hash, error) {
	ret := _m.Called()
	...
	var r2 *common.Hash
	if rf, ok := ret.Get(2).(func() *common.Hash); ok {
		r2 = rf()
	} else {
		if ret.Get(2) != nil {
...
func (_m *Transaction) GetTxFullBurnData() (bool, coin.Coin, coin.Coin, *common.Hash, error) {
	ret := _m.Called()
...
func (_m *Transaction) GetTxMintData() (bool, coin.Coin, *common.Hash, error) {
	ret := _m.Called()
...
func (_m *Transaction) GetValidationEnv() metadata.ValidationEnviroment {
	ret := _m.Called()

	var r0 metadata.ValidationEnviroment
	if rf, ok := ret.Get(0).(func() metadata.ValidationEnviroment); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(metadata.ValidationEnviroment)
		}
	}
...
func (_m *Transaction) HashWithoutMetadataSig() *common.Hash {
	ret := _m.Called()
...
func (_m *Transaction) ListOTAHashH() []common.Hash {
	ret := _m.Called()
...
func (_m *Transaction) SetValidationEnv(_a0 metadata.ValidationEnviroment) {
	_m.Called(_a0)
}
...
func (_m *Transaction) ValidateSanityDataWithBlockchain(chainRetriever metadata.ChainRetriever, shardViewRetriever metadata.ShardViewRetriever, beaconViewRetriever metadata.BeaconViewRetriever, beaconHeight uint64) (bool, error) {
...
func (_m *Transaction) ValidateTransaction(_a0 map[string]bool, _a1 *statedb.StateDB, _a2 *statedb.StateDB, _a3 byte, _a4 *common.Hash) (bool, []proof.Proof, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4)

	var r0 bool
	if rf, ok := ret.Get(0).(func(map[string]bool, *statedb.StateDB, *statedb.StateDB, byte, *common.Hash) bool); ok {
	...
	var r1 []proof.Proof
	if rf, ok := ret.Get(1).(func(map[string]bool, *statedb.StateDB, *statedb.StateDB, byte, *common.Hash) []proof.Proof); ok {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(map[string]bool, *statedb.StateDB, *statedb.StateDB, byte, *common.Hash) error); ok {
...
func (_m *Transaction) ValidateTxByItself(_a0 map[string]bool, _a1 *statedb.StateDB, _a2 *statedb.StateDB, _a3 metadata.ChainRetriever, _a4 byte, _a5 metadata.ShardViewRetriever, _a6 metadata.BeaconViewRetriever) (bool, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4, _a5, _a6)

	var r0 bool
	if rf, ok := ret.Get(0).(func(map[string]bool, *statedb.StateDB, *statedb.StateDB, metadata.ChainRetriever, byte, metadata.ShardViewRetriever, metadata.BeaconViewRetriever) bool); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(map[string]bool, *statedb.StateDB, *statedb.StateDB, metadata.ChainRetriever, byte, metadata.ShardViewRetriever, metadata.BeaconViewRetriever) error); ok {
...
func (_m *Transaction) Verify(_a0 map[string]bool, _a1 *statedb.StateDB, _a2 *statedb.StateDB, _a3 byte, _a4 *common.Hash) (bool, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(map[string]bool, *statedb.StateDB, *statedb.StateDB, byte, *common.Hash) error); ok {
		r1 = rf(_a0, _a1, _a2, _a3, _a4)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *Transaction) VerifyMinerCreatedTxBeforeGettingInBlock(_a0 *metadata.MintData, _a1 byte, _a2 metadata.ChainRetriever, _a3 *metadata.AccumulatedValues, _a4 metadata.ShardViewRetriever, _a5 metadata.BeaconViewRetriever) (bool, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3, _a4, _a5)

	var r0 bool
	if rf, ok := ret.Get(0).(func(*metadata.MintData, byte, metadata.ChainRetriever, *metadata.AccumulatedValues, metadata.ShardViewRetriever, metadata.BeaconViewRetriever) bool); ok {
