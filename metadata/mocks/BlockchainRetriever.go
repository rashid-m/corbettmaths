...
func (_m *BlockchainRetriever) GetBNBChainID() string {
	ret := _m.Called()
...
func (_m *BlockchainRetriever) GetBTCChainID() string {
	ret := _m.Called()
...
func (_m *BlockchainRetriever) GetBTCHeaderChain() *btcrelaying.BlockChain {
	ret := _m.Called()
...
func (_m *BlockchainRetriever) GetPortalFeederAddress() string {
	ret := _m.Called()
