...
func (iRes PDETradeResponse) VerifyMinerCreatedTxBeforeGettingInBlock(txsInBlock []Transaction, txsUsed []int, insts [][]string, instUsed []int, shardID byte, tx Transaction, bcr ChainRetriever, ac *AccumulatedValues, retriever ShardViewRetriever, viewRetriever BeaconViewRetriever) (bool, error) {
	idx := -1
