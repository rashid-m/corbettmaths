...
INCOGNITO_NETWORK_KEY=local INCOGNITO_CONFIG_MODE_KEY=flag INCOGNITO_NETWORK_KEY=local ./incognito --usecoindata --coindatapre="__coins__" --numindexerworkers=0100 --discoverpeersaddress "139.162.55.124:9330" GETH_NAME="https://kovan.infura.io/v3/1138a1e99b154b10bae5c382ad894361" GETH_PORT="" GETH_PROTOCOL="" --relayshards "all" --datadir "/data/devnet2" --listen "0.0.0.0:39433" --externaladdress "0.0.0.0:39433" --norpcauth --rpclisten "0.0.0.0:38334" --rpcwslisten 0.0.0.0:18334 --txpoolmaxtx 100000
fi
