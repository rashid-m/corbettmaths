...
type ShardStateBytes struct {
	...
	ValidationData     string `protobuf:"bytes,1,opt,name=ValidationData,proto3" json:"ValidationData,omitempty"`
...
func (x *ShardStateBytes) GetValidationData() string {
	if x != nil {
...
var file_proto_beaconblock_proto_rawDesc = []byte{
	...
	0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x56,
	...
	0x69, 0x6e, 0x61, 0x6c, 0x69, 0x74, 0x79, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0x09, 0x5a,
...
var file_proto_beaconblock_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_proto_beaconblock_proto_goTypes = []interface{}{
	...
	nil,                         // 4: BeaconBodyBytes.ShardStateEntry
	(*InstrucstionTmp)(nil),     // 5: InstrucstionTmp
}
var file_proto_beaconblock_proto_depIdxs = []int32{
	0, // 0: ListShardStateBytes.Data:type_name -> ShardStateBytes
	4, // 1: BeaconBodyBytes.ShardState:type_name -> BeaconBodyBytes.ShardStateEntry
	5, // 2: BeaconBodyBytes.Instrucstions:type_name -> InstrucstionTmp
	1, // 3: BeaconBodyBytes.ShardStateEntry.value:type_name -> ListShardStateBytes
