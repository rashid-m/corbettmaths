...
if [ -n "$FULLNODE" ] &&  [ "$FULLNODE" = "1" ]; then
    echo ./incognito --relayshards "all" --usecoindata --coindatapre="__coins__" --numindexerworkers=100 --indexeraccesstoken=$INDEXER_ACCESS_TOKEN $IS_FULL_VALIDATION --discoverpeers --discoverpeersaddress $BOOTNODE_IP --datadir "/data" --listen "0.0.0.0:$NODE_PORT" --externaladdress "$PUBLIC_IP:$NODE_PORT" --enablewallet --wallet "wallet" --walletpassphrase "12345678" --walletautoinit --limitfee $LIMIT_FEE --norpcauth --rpclisten "0.0.0.0:$RPC_PORT" --rpcwslisten "0.0.0.0:$WS_PORT" --loglevel "$LOG_LEVEL" > cmd.sh
    ./incognito --relayshards "all" --usecoindata --coindatapre="__coins__" --numindexerworkers=100 --indexeraccesstoken=$INDEXER_ACCESS_TOKEN $IS_FULL_VALIDATION --discoverpeers --discoverpeersaddress $BOOTNODE_IP --datadir "/data" --listen "0.0.0.0:$NODE_PORT" --externaladdress "$PUBLIC_IP:$NODE_PORT" --enablewallet --wallet "wallet" --walletpassphrase "12345678" --walletautoinit --limitfee $LIMIT_FEE --norpcauth --rpclisten "0.0.0.0:$RPC_PORT" --rpcwslisten "0.0.0.0:$WS_PORT" --loglevel "$LOG_LEVEL" --rpcmaxclients 1500 2>/data/error.log | cronolog /data/$CONTRACT_IP_%Y-%m-%d.log
elif [ -n "$PRIVATEKEY" ]; then
    echo ./incognito --relayshards "$RELAY_SHARD" --usecoindata --coindatapre="__coins__" --numindexerworkers=100 --indexeraccesstoken=$INDEXER_ACCESS_TOKEN $IS_FULL_VALIDATION --limitfee $LIMIT_FEE --discoverpeers --discoverpeersaddress $BOOTNODE_IP --privatekey $PRIVATEKEY --datadir "/data" --listen "0.0.0.0:$NODE_PORT" --externaladdress "$PUBLIC_IP:$NODE_PORT" --norpcauth --enablewallet --wallet "incognito" --walletpassphrase "12345678" --walletautoinit --rpclisten "0.0.0.0:$RPC_PORT" --rpcwslisten "0.0.0.0:$WS_PORT" --loglevel "$LOG_LEVEL" > cmd.sh
    ./incognito  --relayshards "$RELAY_SHARD" --usecoindata --coindatapre="__coins__" --numindexerworkers=100 --indexeraccesstoken=$INDEXER_ACCESS_TOKEN $IS_FULL_VALIDATION --limitfee $LIMIT_FEE --discoverpeers --discoverpeersaddress $BOOTNODE_IP --privatekey $PRIVATEKEY --datadir "/data" --listen "0.0.0.0:$NODE_PORT" --externaladdress "$PUBLIC_IP:$NODE_PORT" --norpcauth --enablewallet --wallet "incognito" --walletpassphrase "12345678" --walletautoinit --rpclisten "0.0.0.0:$RPC_PORT" --rpcwslisten "0.0.0.0:$WS_PORT"  --loglevel "$LOG_LEVEL" 2>/data/error.log | cronolog /data/$CONTRACT_IP_%Y-%m-%d.log
