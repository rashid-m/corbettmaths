...
VALIDATOR_K="validator_key_1,
             validator_key_2,
             validator_key_3"
VALIDATOR_K=12WC5ixEmKLzxYTqdSQMCLh1MfCTH9eMrt515ApFi1cckwBcfXA
...
PORT_RPC="8334"  # change this if you prefer other port, 
  # the first node will use this port, the next one use this port+1 and so on
...
ENABLE_COIN_INDEXER=1 # set to 1 to enable, 0 to disable
INDEXER_ACCESS_TOKEN="edeaaff3f1774ad2888673770c6d64097e391bc362d7d6fb34982ddf0efd18cb" 
  # can be generated by running: $ echo "bla bla bla" | sha256sum
