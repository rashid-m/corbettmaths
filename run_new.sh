#!/usr/bin/env bash
if [ "$1" == "1" ]; then
go run *.go --discoverpeersaddress "0.0.0.0:9330" --miningkeys "bls:14DrMrsYZ58EqrjbuyBuTy3NBmcXB" --nodemode "auto" --datadir "data/1" --listen "0.0.0.0:9435" --externaladdress "0.0.0.0:9435" --norpcauth --rpclisten "0.0.0.0:9335"
fi
if [ "$1" == "2" ]; then
