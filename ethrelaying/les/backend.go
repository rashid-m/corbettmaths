...
import (
	...
	"github.com/incognitochain/incognito-chain/ethrelaying/accounts"
	...
	"github.com/incognitochain/incognito-chain/ethrelaying/common/mclock"
	"github.com/incognitochain/incognito-chain/ethrelaying/consensus"
	"github.com/incognitochain/incognito-chain/ethrelaying/core"
	"github.com/incognitochain/incognito-chain/ethrelaying/core/bloombits"
	"github.com/incognitochain/incognito-chain/ethrelaying/core/rawdb"
	...
	"github.com/incognitochain/incognito-chain/ethrelaying/eth/downloader"
	"github.com/incognitochain/incognito-chain/ethrelaying/eth/filters"
	"github.com/incognitochain/incognito-chain/ethrelaying/eth/gasprice"
	"github.com/incognitochain/incognito-chain/ethrelaying/event"
	"github.com/incognitochain/incognito-chain/ethrelaying/internal/ethapi"
	"github.com/incognitochain/incognito-chain/ethrelaying/light"
	"github.com/incognitochain/incognito-chain/ethrelaying/log"
	"github.com/incognitochain/incognito-chain/ethrelaying/node"
	"github.com/incognitochain/incognito-chain/ethrelaying/p2p"
	"github.com/incognitochain/incognito-chain/ethrelaying/p2p/discv5"
	"github.com/incognitochain/incognito-chain/ethrelaying/params"
	rpc "github.com/incognitochain/incognito-chain/ethrelaying/rpc"
)
...
func NewLightETHForRelaying(
	ctx *node.ServiceContext,
	config *eth.Config,
	dataDir string,
) (*LightEthereum, error) {
	chainDb, err := ctx.OpenDatabase(
		fmt.Sprintf("%s/ethlightchaindata", dataDir),
		config.DatabaseCache,
		config.DatabaseHandles,
		fmt.Sprintf("%s/eth/db/chaindata/", dataDir),
	)
	if err != nil {
		return nil, err
	}
	...
	leth.odr = NewLesOdr(chainDb, light.DefaultClientIndexerConfig, nil)
...
func (s *LightEthereum) GetLightChain() *light.LightChain {
	return s.blockchain
}
