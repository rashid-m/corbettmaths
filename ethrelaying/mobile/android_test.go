...
import (
	...
	"github.com/incognitochain/incognito-chain/ethrelaying/internal/build"
)
...
func TestAndroid(t *testing.T) {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.ethereum", "github.com/incognitochain/incognito-chain/ethrelaying/mobile")
